...
def clip_boxes(boxes, im_shape, batch_size):
    ...
    for i in range(batch_size):
        boxes[i, :, 0::4].clamp_(0, im_shape[i, 1] - 1)    # shrink x1 to interval [0, w-1]
        boxes[i, :, 1::4].clamp_(0, im_shape[i, 0] - 1)    # shrink y1 to interval [0, h-1]
        boxes[i, :, 2::4].clamp_(0, im_shape[i, 1] - 1)    # shrink x2 to interval [0, w-1]
        boxes[i, :, 3::4].clamp_(0, im_shape[i, 0] - 1)    # shrink y2 to interval [0, h-1]
