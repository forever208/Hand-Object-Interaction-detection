...
class resnet(_fasterRCNN):
    ...
    def __init__(self, classes, num_layers=101, pretrained=False, class_agnostic=False):
        ...
        self.model_path = 'data/pretrained_model/resnet' + str(self.num_layers) + '.pth'    # path of the pre-trained weights
    ...
    def _init_modules(self):
        ...
        # self.RCNN_cls_score = nn.Sequential(nn.Linear(2048, 32), \
        #                                     nn.ReLU(), \
        ...
        # if self.class_agnostic:
        #     self.RCNN_bbox_pred = nn.Sequential(nn.Linear(2048, 32), \
        #                                         nn.ReLU(), \
        #                                         nn.Linear(32, 4))
        # else:
        #     self.RCNN_bbox_pred = nn.Sequential(nn.Linear(2048, 32), \
        #                                         nn.ReLU(), \
        #                                         nn.Linear(32, 4 * self.n_classes))
